...
{	
	[TestFixture]
	public class TestCustomerOrderTraditionalTransactions 
	{
		protected string _connectionString ;
		protected SqlConnection _connection ;
		protected SqlTransaction _transaction ;
		
		public TestCustomerOrderTraditionalTransactions()
		{
		...
		public void TestLoad()
		{
			...
			List<NW.query.CustomerOrder> rowset = factory.Load( _connection, null, null, _transaction );
		...
		public void TestLoadByCustomer()
		{
			...
			List<NW.query.CustomerOrder> rowset = factory.LoadByCustomer( _connection, customerId, null,  null,_transaction ) ;
		...
		public void TestLoadByRegion()
		{
			...
			List<NW.query.CustomerOrder> rowset = factory.LoadByRegion( _connection, region, null, null, _transaction ) ;
		...
		public void TestLoadByCustomerIdEmployeeIdOrderDateFreight()
		{
			...
			List<NW.query.CustomerOrder> rowset = factory.LoadByCustomerIdEmployeeIdOrderDateFreight( _connection, customerId, employeeId, orderDate, freight, null, null, _transaction ) ; 
			Console.WriteLine(rowset.Count);
			Assert.Greater(rowset.Count, 0); // should get some rows back
		...
		public void TestLoadByShippedDateNull()
		{
			...
			List<NW.query.CustomerOrder> rowset = factory.LoadByShippedDate( _connection, shippedDate, null, null, _transaction ) ;
			Console.WriteLine(rowset.Count);
			Assert.Greater(rowset.Count, 0); // should get some rows back
