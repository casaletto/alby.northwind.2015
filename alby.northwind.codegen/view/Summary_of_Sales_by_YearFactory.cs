...
{
	public partial class Summary_of_Sales_by_YearFactory : acr.FactoryBase< Summary_of_Sales_by_Year, ns.database.NorthwindDatabaseSingletonHelper, ns.database.NorthwindDatabase >
	{
		static Summary_of_Sales_by_YearFactory() 
		{
			_assemblyˡ = sr.Assembly.GetExecutingAssembly() ;
			_schemaˡ = "dbo" ;
			_tableˡ = "Summary of Sales by Year" ;
			_selectˡ = "select * from {0} t  " ;
		}

		public scg.List<Summary_of_Sales_by_Year> Loadˡ
		(
		...
		public scg.List<Summary_of_Sales_by_Year> LoadByWhereˡ
		(
			sds.SqlConnection connˡ,
			string whereˡ,
