...
{
	public partial class Order_SubtotalsFactory : acr.FactoryBase< Order_Subtotals, ns.database.NorthwindDatabaseSingletonHelper, ns.database.NorthwindDatabase >
	{
		static Order_SubtotalsFactory() 
		{
			_assemblyˡ = sr.Assembly.GetExecutingAssembly() ;
			_schemaˡ = "dbo" ;
			_tableˡ = "Order Subtotals" ;
			_selectˡ = "select * from {0} t  " ;
		}

		public scg.List<Order_Subtotals> Loadˡ
		(
		...
		public scg.List<Order_Subtotals> LoadByWhereˡ
		(
			sds.SqlConnection connˡ,
			string whereˡ,
