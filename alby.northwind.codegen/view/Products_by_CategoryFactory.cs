...
{
	public partial class Products_by_CategoryFactory : acr.FactoryBase< Products_by_Category, ns.database.NorthwindDatabaseSingletonHelper, ns.database.NorthwindDatabase >
	{
		static Products_by_CategoryFactory() 
		{
			_assemblyˡ = sr.Assembly.GetExecutingAssembly() ;
			_schemaˡ = "dbo" ;
			_tableˡ = "Products by Category" ;
			_selectˡ = "select * from {0} t  " ;
		}

		public scg.List<Products_by_Category> Loadˡ
		(
		...
		public scg.List<Products_by_Category> LoadByWhereˡ
		(
			sds.SqlConnection connˡ,
			string whereˡ,
