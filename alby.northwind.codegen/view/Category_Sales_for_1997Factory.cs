...
{
	public partial class Category_Sales_for_1997Factory : acr.FactoryBase< Category_Sales_for_1997, ns.database.NorthwindDatabaseSingletonHelper, ns.database.NorthwindDatabase >
	{
		static Category_Sales_for_1997Factory() 
		{
			_assemblyˡ = sr.Assembly.GetExecutingAssembly() ;
			_schemaˡ = "dbo" ;
			_tableˡ = "Category Sales for 1997" ;
			_selectˡ = "select * from {0} t  " ;
		}

		public scg.List<Category_Sales_for_1997> Loadˡ
		(
		...
		public scg.List<Category_Sales_for_1997> LoadByWhereˡ
		(
			sds.SqlConnection connˡ,
			string whereˡ,
