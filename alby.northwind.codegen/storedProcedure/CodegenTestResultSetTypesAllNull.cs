...
namespace alby.northwind.codegen.storedProcedure
{
	...
	{
		public int CodegenTestResultSetTypesAllNull
		(
			sds.SqlConnection connˡ, 
			out scg.List<CodegenTestResultSetTypesAllNull٠rs1> rsˡ1, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "CodegenTestResultSetTypesAllNull" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<CodegenTestResultSetTypesAllNull٠rs1>( dsˡ, 1 ) ;
