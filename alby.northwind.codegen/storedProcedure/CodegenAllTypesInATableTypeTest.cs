...
namespace alby.northwind.codegen.storedProcedure
{
	...
	{
		public int CodegenAllTypesInATableTypeTest
		(
			sds.SqlConnection connˡ, 
			scg.List<MyAllTypesInATableType٠tt> list, 
			out scg.List<CodegenAllTypesInATableTypeTest٠rs1> rsˡ1, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "CodegenAllTypesInATableTypeTest" ; 
			 
			scg.List<sds.SqlParameter> parametersˡ = new scg.List<sds.SqlParameter>() ;
			sds.SqlParameter paramˡlist = base.AddParameterTableTypeˡ( parametersˡ, "@list", this.CodegenAllTypesInATableTypeTest٠listˡ( list ), "dbo.MyAllTypesInATableType" ) ; 
			...
			rsˡ1 = base.ToRecordsetˡ<CodegenAllTypesInATableTypeTest٠rs1>( dsˡ, 1 ) ;
			 
			return base.GetParameterValueˡ<int>( paramˡrcˡ ) ;
		}
		 
		protected object CodegenAllTypesInATableTypeTest٠listˡ( scg.List<MyAllTypesInATableType٠tt> list )
		{
			if ( list == null ) return null ;
			if ( list.Count == 0 ) return null ;
			return new  ns.storedProcedure.MyAllTypesInATableType٠ttlist( list ) ;
		}
	}
