...
namespace alby.northwind.codegen.storedProcedure
{
	...
	{
		public int sp_helpdiagramdefinition
		(
			sds.SqlConnection connˡ, 
			string diagramname, 
			int? owner_id, 
			out scg.List<sp_helpdiagramdefinition٠rs1> rsˡ1, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "sp_helpdiagramdefinition" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<sp_helpdiagramdefinition٠rs1>( dsˡ, 1 ) ;
