...
namespace alby.northwind.codegen.storedProcedure
{
	...
	{
		public int Employee_Sales_by_Country
		(
			sds.SqlConnection connˡ, 
			DateTime? Beginning_Date, 
			DateTime? Ending_Date, 
			out scg.List<Employee_Sales_by_Country٠rs1> rsˡ1, 
			sds.SqlTransaction tranˡ = null
		)
		{
			const string schemaˡ = "dbo" ; 
			const string spˡ = "Employee Sales by Country" ; 
			...
			rsˡ1 = base.ToRecordsetˡ<Employee_Sales_by_Country٠rs1>( dsˡ, 1 ) ;
