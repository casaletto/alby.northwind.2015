...
namespace alby.northwind.codegen.storedProcedure
{
	public partial class StoredProcedureFactory : acr.StoredProcedureFactoryBase< ns.database.NorthwindDatabaseSingletonHelper, ns.database.NorthwindDatabase >
	{
		...
		)
		{
			...
			const string spˡ = "sp_creatediagram" ; 
			...
			sds.SqlParameter paramˡversion = base.AddParameterˡ( parametersˡ, "@version", version, sd.SqlDbType.Int, true, null, 10, 0 ) ; 
			sds.SqlParameter paramˡdefinition = base.AddParameterˡ( parametersˡ, "@definition", definition, sd.SqlDbType.VarBinary, true, -1, null, null ) ; 
